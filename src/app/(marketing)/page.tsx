...
export default function Home() {
  ...
  return (
    <div className="w-full h-auto md:h-screen overflow-y-auto md:overflow-hidden flex flex-col items-center justify-center px-24">
      <div className="w-full max-w-7xl mx-auto flex flex-col my-2">
        <div className="w-full flex justify-between">
          <div className="relative hidden md:flex w-1/3 bg-black items-center justify-center group/titan ">
            <Goku />
            <div className="absolute top-0 left-0 size-4  opacity-0 group-hover/titan:opacity-100 transition-all duration-200"></div>
            <div className="absolute top-0 right-0 size-4  opacity-0 group-hover/titan:opacity-100 transition-all duration-200"></div>
            <div className="absolute bottom-0 left-0 size-4  opacity-0 group-hover/titan:opacity-100 transition-all duration-200"></div>
            <div className="absolute bottom-0 right-0 size-4  opacity-0 group-hover/titan:opacity-100 transition-all duration-200"></div>
          </div>
          <div className="flex-1 flex flex-col">
            <div id="nav" className="w-full flex items-center justify-end ">
              <div id="brand" className="font-mono text-sm flex-1 flex items-center h-full px-3 ">
            ...
            <div id="hero" className="flex flex-col p-4">
              <h1 className="head-text-md">Todo Ultra</h1>
              <p className="text-muted-foreground max-w-3xl">{siteConfig.description}</p>
            </div>
            <div id="code" className="flex flex-col p-4">
              <div className="p-2 border border hover:border-primary/50 bg-card text-xs md:text-sm flex items-center justify-between transition-all duration-200 delay-75">
